...
const ORDER_MAIL_TEMPLATES = {
  ...
  refunded: {
    subject: "Sipariş iadeniz işleme alındı",
    heading: "Sipariş iadeniz işleme alındı",
    summary:
      "Siparişiniz için iade kaydı oluşturuldu. Banka ve kart kurallarına göre tutarın hesabınıza yansıması birkaç iş günü sürebilir; sorularınız için bize yazabilirsiniz.",
  },
  invoice: {
...
const NOTIFY_STATUSES = new Set(["paid", "preparing", "shipped", "cancelled", "refunded"]);

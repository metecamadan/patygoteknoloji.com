...
function canonicalCategoryTree() {
  return sortParentsForNav([
    ...
    node(
      ...
      [
        node("Bellekler", [
          node("PC Belleği DDR3", null, ["DDR3", "PC DDR3", "Masaüstü DDR3"]),
          node("PC Belleği DDR4", null, ["DDR4", "PC DDR4", "Masaüstü DDR4"]),
          node("PC Belleği DDR5", null, ["PC DDR5", "Masaüstü DDR5", "Desktop DDR5"]),
          node("Notebook Belleği DDR3", null, ["Notebook DDR3", "Laptop DDR3"]),
          node("Notebook Belleği DDR4", null, ["Notebook DDR4", "Laptop DDR4"]),
          node("Notebook Belleği DDR5", null, ["Notebook DDR5", "Laptop DDR5"]),
        ]),

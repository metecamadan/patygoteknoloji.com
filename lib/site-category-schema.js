...
function sortParentsForNav(tree) {
  ...
  rank.set("BASKI ÇÖZÜMLERİ", 0);
  rank.set("YAPI GEREÇLERİ", 1);
  rank.set("OFİS ÜRÜNLERİ", 2);
  rank.set("BİLGİSAYAR / TABLET", 3);
  rank.set("BİLGİSAYAR BİLEŞENLERİ", 4);
  rank.set("KARTUŞ TONER", 5);

...
function canonicalCategoryTree() {
  return sortParentsForNav([
    ...
    node(
      ...
      [
        node("Bellekler", [
          node("PC Belleği DDR3", null, ["PC Belleği - DDR3", "PC Belleği DDR3", "DDR3", "PC DDR3", "Masaüstü DDR3"]),
          node("PC Belleği DDR4", null, ["PC Belleği - DDR4", "PC Belleği DDR4", "DDR4", "PC DDR4", "Masaüstü DDR4"]),
          node("PC Belleği DDR5", null, ["PC Belleği - DDR5", "PC Belleği DDR5", "PC DDR5", "Masaüstü DDR5", "Desktop DDR5"]),
          node("Notebook Belleği DDR3", null, ["Notebook Belleği - DDR3", "Notebook Belleği DDR3", "Notebook DDR3", "Laptop DDR3"]),
          node("Notebook Belleği DDR4", null, ["Notebook Belleği - DDR4", "Notebook Belleği DDR4", "Notebook DDR4", "Laptop DDR4"]),
          node("Notebook Belleği DDR5", null, ["Notebook Belleği - DDR5", "Notebook Belleği DDR5", "Notebook DDR5", "Laptop DDR5"]),
        ]),

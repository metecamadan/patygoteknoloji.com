...
const FOOTER_GRID = `
      <div class="footer-grid">
        ...
        <div class="footer-col">
          <h4>Kategoriler</h4>
          <a href="/urunler/bilgisayar-tablet">Bilgisayar ve tablet</a>
          <a href="/urunler/bilgisayar-bilesenleri">Bilgisayar bileşenleri</a>
          <a href="/urunler/kartus-toner">Kartuş ve toner</a>
          <a href="/urunler/baski-cozumleri">Baskı çözümleri</a>
          <a href="/urunler/yapi-gerecleri">Yapı gereçleri</a>
          <a href="/urunler/ofis-urunleri">Ofis ürünleri</a>
        </div>
        <div class="footer-col">
          <h4>Yasal</h4>
